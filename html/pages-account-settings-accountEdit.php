                            ...
                            <div class="row">
                              ...
                              <div class="mb-3 row">
                                <div class="mb-3 col-md-4">
                                  ...
                                  <input class="form-control" type="text" name="firstName" id="firstName" value="<?php echo $objResult['STUDENTNAME']?>" />
                                </div>
                                <div class="mb-3 col-md-4">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="mb-3 col-md-1">
                                  ...
                                  <select name="term" class="form-select color-dropdown">
                                    ...
                                    <option value="bg-primary" ><?php echo $objResult['ADMITSEMESTER'] ?></option>
                                ...
                                <div class="mb-3 col-md-2">
                                  ...
                                  <select name="levels" class="form-select color-dropdown">
                                      ...
                                      <option value="1" id="1">ปริญญาเอก</option>
                                    <option value="2" id="2" >ปริญญาโท</option>
                              ...
                              <div class="mb-3 row">
                                <div class="mb-3 col-md-4">
                                  ...
                                  <input type="text" class="form-control"  name="Faculty" value="<?php echo $objResult['FACULTYNAME']?>" />
                                </div>
                                <div class="mb-3 col-md-4">
                                  <label for="Major" class="form-label">สาขา</label>
                                  <input class="form-control" type="text" id="Major" name="Major" value="<?php echo $objResult['PROGRAMNAME']?>" />
                                </div>
                              </div>
