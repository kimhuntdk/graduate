...
<?php
 ...
 if(count($_POST)>0) {
    ...
    $result = mysqli_query($mysqli,"SELECT * FROM status_student where s_std='$roll_no' ");
    }
 else{
    echo "ไม่พบข้อมูล";
 }
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">ประวัติ /</span> ลำดับขั้นตอนการศึกษา
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="pages-account-settings-accountAdd.php"
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="pages-account-settings-connections.html"
                        ><i class="bx bx-link-alt me-1"></i> ช่องทางการติดต่อ</a
                      >
                    </li>
                  ...
                  <div class="content-wrapper">
                    ...
                    <div class="table-responsive text-nowrap">
                      <table width="300" border="3" align="start"class="table table-bordered">
                        <thead>
                        <tr>
                          <th width="20"> <div align="center">ID </div></th>
                          <th width="20"> <div align="center">ID Student </div></th>
                          ...
                          <th width="71"> <div align="center">faculty </div></th>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://grad.msu.ac.th/th/" target="_blank" class="footer-link fw-bolder">Graduate School Mahasarakham Univeersity</a>
                </div>
